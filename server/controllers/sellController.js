...
const handleSell = async (req,res) => {
    const{email,brand,model,variant,transmission,kilometers,owner,type,price,starttime,endtime,description,imgArray}=req.body;
            ...
            function upload(images){
                console.log(images);
                const activity=0
                console.log({email,activity,date,brand,model,variant,transmission,kilometers,owner,status,type,price,startTime,endTime,description,images})
                Car.create({email,activity,date,brand,model,variant,transmission,kilometers,owner,status,type,price,startTime,endTime,description,images})
                res.json("Created")
            }
}
