...
export const Predict = () => {
  ...
  return (
    <div>
      <Navbar/>
      <div className='flex-wrap  flex md:pl-[80px] pl-[50px] py-[10px]  bg-gray-700 fixed z-10 w-full justify-center'><p className='text-white text-4xl md:mr-40 mr-10'>AI Powered Price Calculation</p></div>
