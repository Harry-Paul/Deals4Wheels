    ...
    <div className='bg-white py-10 px-20 rounded-3xl' >
      ...
      <div className='mt-6'>
        ...
        <div className='mt-6 flex flex-col gap-y-4'>
            <button onClick={submit} className='active:scale-[0.98] ease-in-out active:duration-75 hover:scale-[1.01] transition-all py-2 rounded-xl bg-gray-800 text-white xl:text-[17px] lg:text-[16px] md:text-[15px] text-[14px] font-bold'>Sign In</button>
